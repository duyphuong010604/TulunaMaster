        ...
        <div class="row">
            <div class="col-md-8 mx-auto col-12">
                <div class="login_form_inner">
                    ...
                    <?php  if (isset($True['message']))    
                                    echo "<br><span class='text-star' style='color: green;'>" . $True['message'] . "</span><br>"; ?>
                    <form class="row login_form mb-5" action="<?= $ROOT_URL?>/routerClient.php?act=quenmatkhau" method="post" id="contactForm"
