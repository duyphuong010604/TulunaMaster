                    ...
                    <div class="row single-slide align-items-center d-flex">
                        ...
                        <div class="col-lg-7">
                            <div class="banner-img">
                                <img class="img-fluid" src="<?=$CONTENT_URL?>/client/img/banner/banner-img.png" alt="">
                            </div>
                        </div>
                    </div>
                    <!-- single-slide -->
    ...
    <div class="single-product-slider">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="single-product">
                        <img class="img-fluid" src="<?=$CONTENT_URL?>/client/img/product/p2.jpg" alt="">
                        <div class="product-details">
                            <h6>addidas New Hammer sole
                                for Sports person</h6>
                            <div class="price">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="single-product">
                        <img class="img-fluid" src="<?=$CONTENT_URL?>/client/img/product/p7.jpg" alt="">
                        <div class="product-details">
                            <h6>addidas New Hammer sole
                                for Sports person</h6>
                            <div class="price">
        ...
        <div class="row justify-content-center align-items-center">
            <div class="col-lg-6 no-padding exclusive-left">
                <div class="row clock_sec clockdiv" id="clockdiv">
                    <div class="col-lg-12">
                        <h1>Hiển thị thời gian bất đầu kết thúc mã khuyến mãi</h1>
                ...
                <a href="" class="primary-btn">Đến danh mục sale</a>
            </div>
    ...
    <div class="container">
        <div class="row">
            <a class="col single-img" href="#">
                <img class="img-fluid d-block mx-auto" src="<?=$CONTENT_URL?>/client/img/brand/1.png" alt="">
            </a>
            <a class="col single-img" href="#">
                <img class="img-fluid d-block mx-auto" src="<?=$CONTENT_URL?>/client/img/brand/2.png" alt="">
            </a>
            <a class="col single-img" href="#">
                <img class="img-fluid d-block mx-auto" src="<?=$CONTENT_URL?>/client/img/brand/3.png" alt="">
            </a>
            <a class="col single-img" href="#">
                <img class="img-fluid d-block mx-auto" src="<?=$CONTENT_URL?>/client/img/brand/4.png" alt="">
            </a>
            <a class="col single-img" href="#">
                <img class="img-fluid d-block mx-auto" src="<?=$CONTENT_URL?>/client/img/brand/5.png" alt="">
            </a>
        </div>
    </div>
</section>
            ...
            <div class="col-lg-3">
                <div class="ctg-right">
                    <a href="#" target="_blank">
                        <img class="img-fluid d-block mx-auto" src="<?=$CONTENT_URL?>/client/img/category/c5.jpg" alt="">
                    </a>
                </div>
            </div>
        </div>
