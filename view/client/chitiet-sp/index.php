            ...
            <div class="col-lg-6">
                <div class="s_Product_carousel">
                    <div class="single-prd-item">
                        <img class="img-fluid" src="<?=$CONTENT_URL?>/client/img/category/s-p1.jpg" alt="">
                    </div>
                    <div class="single-prd-item">
                        <img class="img-fluid" src="<?=$CONTENT_URL?>/client/img/category/s-p1.jpg" alt="">
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="comment_list">
                            <div class="review_item">
                                <div class="media">
                                    <div class="d-flex">
                                        <img src="<?=$CONTENT_URL?>/client/img/product/review-1.png" alt="">
                                    </div>
                            ...
                            <div class="review_item">
                                <div class="media">
                                    <div class="d-flex">
                                        <img src="<?=$CONTENT_URL?>/client/img/product/review-3.png" alt="">
                                    </div>
                                    <div class="media-body">
                                        <h4>Blake Ruiz</h4>
                                        <h5>12th Feb, 2018 at 05:56 pm</h5>
