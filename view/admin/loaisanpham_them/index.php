                    ...
                    <div class="row">
                        ...
                        <div class="col-xxl">
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    <form action="<?= $ROOT_URL ?>/routerAdmin.php?act=loaisanpham_them" method="post"
                                            ...
                                            <div class="col-sm-10">
                                                <div class="input-group input-group-merge">
                                                    ...
                                                    <input type="text" class="form-control" id="name"
                                                        placeholder="Tên loại sản phẩm" name="name" required />
                                        ...
                                        <div class="row justify-content-end">
                                            <div class="col-sm-10">
                                                <button type="submit" class="btn btn-primary mb-3" name='them'>Thêm
                                                    mới</button>
                                                <?php
